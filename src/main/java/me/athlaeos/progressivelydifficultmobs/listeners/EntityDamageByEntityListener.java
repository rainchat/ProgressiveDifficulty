...
import me.athlaeos.progressivelydifficultmobs.resourse.items.CursedEnemyDropsEnableItem;
...
public class EntityDamageByEntityListener implements Listener {
    ...
    private final NamespacedKey key = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-monsterID");
    private final NamespacedKey monsterCursedKey = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-curse");
    private final NamespacedKey enableCurseDropsItemKey = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-enable_curse_drops");
