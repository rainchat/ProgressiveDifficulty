...
public class EntitySpawnListener implements Listener {
    ...
    private final NamespacedKey monsterSpawnCustom = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-monster_spawn_custom");
    private final NamespacedKey monsterSpawnCursed = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-monster_spawn_cursed");
    ...
    private final double spawnChance = ProgressivelyMain.getInstance().getConfig().getDouble("chance_custom_spawn");
    ...
    public void onMobSpawn(CreatureSpawnEvent e) {
        ...
        if (!e.isCancelled()) {
            ...
            }.runTaskLater(ProgressivelyMain.getInstance(), 1);
        }
    }
}
