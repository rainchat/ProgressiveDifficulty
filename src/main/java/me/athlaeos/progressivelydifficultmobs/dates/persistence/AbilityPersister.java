...
import me.athlaeos.progressivelydifficultmobs.resourse.abilities.CustomizableImmediatePotionEffectAbility;
import me.athlaeos.progressivelydifficultmobs.resourse.abilities.CustomizablePotionEffectOnHitPlayerAbility;
import me.athlaeos.progressivelydifficultmobs.resourse.abilities.CustomizablePotionEffectRetaliationAbility;
import me.athlaeos.progressivelydifficultmobs.resourse.abilities.CustomizablePotionEffectWhenDamagedAbility;
    ...
    public static void loadAbilities() {
        ...
        for (String key : yaml.getConfigurationSection("on_damage_player_abilities").getKeys(false)) {
            try {
                ...
                ProgressivelyMain.getInstance().getServer().getConsoleSender().sendMessage(Utils.chat("&c" +
