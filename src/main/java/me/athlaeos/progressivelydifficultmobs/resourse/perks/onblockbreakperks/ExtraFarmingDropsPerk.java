package me.athlaeos.progressivelydifficultmobs.resourse.perks.onblockbreakperks;
...
public class ExtraFarmingDropsPerk extends Perk {
    private final int wheatBonus;
    private final int carrotBonus;
    private final int potatoBonus;
    private final int beetBonus;
    private final int wartBonus;
    private final int cocoaBonus;
