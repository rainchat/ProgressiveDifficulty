package me.athlaeos.progressivelydifficultmobs.resourse.items;
...
public class RevealEvilItem extends ActiveItem {
    ...
    private final NamespacedKey curseKey = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-curse");
    private final NamespacedKey karmaKey = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-karma");
    ...
    public RevealEvilItem() {
        key = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-revealing");
    ...
    private void createRecipe() {
        ...
        recipe = r;
        ProgressivelyMain.getInstance().getServer().addRecipe(recipe);
    }
