package me.athlaeos.progressivelydifficultmobs.resourse.menus;
...
import me.athlaeos.progressivelydifficultmobs.utils.general.Menu;
...
public class LevelPerkModificationMenu extends Menu {
    ...
    private final NamespacedKey perkIDKey = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm_perk-id");
    private int currentLevelPage = 0;
    private final int minLevelPages;
    private final int maxLevelPages;
