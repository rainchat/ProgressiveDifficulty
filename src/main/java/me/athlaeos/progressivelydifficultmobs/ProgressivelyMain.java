package me.athlaeos.progressivelydifficultmobs;
...
public final class ProgressivelyMain extends JavaPlugin {

    private static ProgressivelyMain plugin;
    private LeveledMonsterManager monsterManager;

    public static ProgressivelyMain getInstance() {
        return plugin;
    }
    ...
    private void EntityRunnableReloader() {
        NamespacedKey key = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-monsterID");
        NamespacedKey monsterCursedKey = new NamespacedKey(ProgressivelyMain.getInstance(), "pdm-curse");
